# sfw/bash/wrapp/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat docs/txt/wrapp/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: sfw/bash/wrapp/funcs/create-relative-7z-package.spec.sh
