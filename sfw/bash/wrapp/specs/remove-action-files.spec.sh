# sfw/bash/wrapp/funcs/remove-action-files.spec.sh
...
doSpecRemoveActionFiles(){
	...
	cat docs/txt/wrapp/specs/remove-action-files.spec.txt
...
# eof file: sfw/bash/wrapp/funcs/remove-action-files.spec.sh
