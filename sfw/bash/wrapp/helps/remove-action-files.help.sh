# sfw/bash/wrapp/funcs/remove-action-files.help.sh
...
doHelpRemoveActionFiles(){
	...
	cat docs/txt/wrapp/helps/remove-action-files.help.txt
...
# eof file: sfw/bash/wrapp/funcs/remove-action-files.help.sh
