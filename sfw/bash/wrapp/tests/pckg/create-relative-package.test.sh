...
doTestCreateRelativePackage(){
	...
	bash sfw/bash/wrapp/wrapp.sh -a create-relative-package
	test -z "$sleep_interval" || sleep "$sleep_interval"
	
	# test the call with the include file of the tst env
	bash sfw/bash/wrapp/wrapp.sh -a create-relative-package -i meta/.tst.wrapp
	test -z "$sleep_interval" || sleep "$sleep_interval"
	
	# test the call with the include file of the prd env
	bash sfw/bash/wrapp/wrapp.sh -a create-relative-package -i meta/.prd.wrapp
	test -z "$sleep_interval" || sleep "$sleep_interval"
	
	# test the call with the include file of the prd env
	bash sfw/bash/wrapp/wrapp.sh -a create-relative-package -i meta/.git.wrapp
	test -z "$sleep_interval" || sleep "$sleep_interval"
