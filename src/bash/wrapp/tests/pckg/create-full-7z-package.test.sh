# src/bash/wrapp/funcs/create-full-7z-package.test.sh
...
doTestCreateFull7zPackage(){
	...
	cat doc/txt/wrapp/tests/pckg/create-full-7z-package.test.txt
...
# eof file: src/bash/wrapp/funcs/create-full-7z-package.test.sh
