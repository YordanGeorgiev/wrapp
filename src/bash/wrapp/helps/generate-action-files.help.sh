# src/bash/wrapp/funcs/generate-action-files.help.sh
...
doHelpGenerateActionFiles(){
	...
	cat doc/txt/wrapp/helps/generate-action-files.help.txt
...
# eof file: src/bash/wrapp/funcs/generate-action-files.help.sh
