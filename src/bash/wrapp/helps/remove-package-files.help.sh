# src/bash/wrapp/funcs/remove-package-files.help.sh
...
doHelpRemovePackageFiles(){
	...
	cat doc/txt/wrapp/helps/remove-package-files.help.txt
...
# eof file: src/bash/wrapp/funcs/remove-package-files.help.sh
