# src/bash/wrapp/funcs/restore-tmux-session.help.sh
...
doHelpRestoreTmuxSession(){
	...
	cat doc/txt/wrapp/helps/restore-tmux-session.help.txt
...
# eof file: src/bash/wrapp/funcs/restore-tmux-session.help.sh
