# src/bash/wrapp/funcs/remove-action-files.help.sh
...
doHelpRemoveActionFiles(){
	...
	cat doc/txt/wrapp/helps/remove-action-files.help.txt
...
# eof file: src/bash/wrapp/funcs/remove-action-files.help.sh
