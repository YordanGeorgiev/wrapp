# src/bash/wrapp/funcs/remove-action-files.spec.sh
...
doSpecRemoveActionFiles(){
	...
	cat doc/txt/wrapp/specs/remove-action-files.spec.txt
...
# eof file: src/bash/wrapp/funcs/remove-action-files.spec.sh
