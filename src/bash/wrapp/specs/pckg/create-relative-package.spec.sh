# src/bash/wrapp/funcs/create-relative-package.spec.sh
...
doSpecCreateRelativePackage(){
	...
	cat doc/txt/wrapp/specs/pckg/create-relative-package.spec.txt
...
# eof file: src/bash/wrapp/funcs/create-relative-package.spec.sh
