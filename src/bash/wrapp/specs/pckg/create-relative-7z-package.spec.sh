# src/bash/wrapp/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat doc/txt/wrapp/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: src/bash/wrapp/funcs/create-relative-7z-package.spec.sh
