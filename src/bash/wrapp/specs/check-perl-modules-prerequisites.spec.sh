# src/bash/wrapp/funcs/check-perl-modules-prerequisites.spec.sh
...
doSpecCheckPerlModulesPrerequisites(){
	...
	cat doc/txt/wrapp/specs/check-perl-modules-prerequisites.spec.txt
...
# eof file: src/bash/wrapp/funcs/check-perl-modules-prerequisites.spec.sh
