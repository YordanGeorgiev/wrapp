#!/usr/bin/env bash
# file: src/bash/wrapp.sh doc at the eof file

# v0.7.1
#------------------------------------------------------------------------------
# the main shell entry point of the wrapp application
#------------------------------------------------------------------------------
main(){
   do_init
...
# stored in the src/bash/wrapp/funcs/run-shell-action.func.sh
#----------------------------------------------------------
#
#----------------------------------------------------------
#  EXIT CODES
...
#
#
#eof file src/bash/wrapp/wrapp.sh
