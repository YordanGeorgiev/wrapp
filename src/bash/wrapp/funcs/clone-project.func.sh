# src/bash/wrapp/funcs/clone-project.func.sh

# v1.0.9
# ---------------------------------------------------------
# cat doc/txt/wrapp/funcs/clone-project.func.txt
# ---------------------------------------------------------
doCloneProject(){
   ...
   # doc/txt/wrapp/spec/clone-project.spec.txt
   export src_proj='ysg-issues'
   export tgt_proj='phz'
   export global_cnf_dir='/vagrant/csitea/cnf/projects/wrapp'
   ...
   bash src/bash/wrapp/wrapp.sh -a increase-date -d today
...
# eof file: src/bash/wrapp/funcs/clone-project.func.sh
